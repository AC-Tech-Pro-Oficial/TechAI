...
export interface WorkspaceProfile {
    name: string;
    match: string[];    // Glob patterns to match workspace
    servers: string[];  // Server IDs to enable for this profile
    resources?: string[]; // Optional: additional resources to inject
    prompts?: string[];   // Optional: additional prompts to expose
}
